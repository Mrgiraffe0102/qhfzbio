...
function QHFZBIO_get_option_defaults() {
	...
	"theme_lpslidercta1text"	=> _x('Read more','Slider CTA Text 1 default value','QHFZBIO'),
	"theme_lpslidercta1link"	=> '#lp-blocks',
	"theme_lpslidercta2text"	=> _x('See more','Slider CTA Text 2 default value','QHFZBIO'),
	"theme_lpslidercta2link"	=> '#lp-boxes-1',
	"theme_lpposts"				=> 1, // 2=static page, 1=posts, 0=disabled
	"theme_lpposts_more"		=> _x('More Posts','Landing page load more posts default label','QHFZBIO'),
	...
	"theme_lpboxreadmore1"		=> _x('Read More','Landing page text boxes 1 default read more label','QHFZBIO'),
	...
	"theme_lpboxreadmore2"		=> _x('Read More','Landing page text boxes 2 default read more label','QHFZBIO'),
	...
	"theme_totop"				=> 'QHFZBIO-totop-normal',
	"theme_tables"				=> 'QHFZBIO-stripped-table',
	"theme_normalizetags"		=> 1, // 0,1
	"theme_copyright"			=> '&copy;'. date_i18n('Y') . ' '. get_bloginfo('name'),

	"theme_articleanimation"	=> "fade", // 0=none, >0=effect

	"theme_image_style"			=> 'QHFZBIO-image-none',
	"theme_caption_style"		=> 'QHFZBIO-caption-one',
	...
	"theme_meta_blog_byline" 	=> 1, // 0 = off, 1 = in header, 2 = before content
	...
	"theme_meta_single_byline" 		=> 1, // 0 = off, 1 = in header
	...
	"theme_excerptcont"		=> _x("Read more","Blog post excerpts default read more label","QHFZBIO"),
	...
	return apply_filters( 'QHFZBIO_option_defaults_array', $QHFZBIO_defaults );
