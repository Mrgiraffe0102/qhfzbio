	...
	<div id="container" class="<?php QHFZBIO_get_layout_class(); ?>">
		<main id="main" class="main">
			...
			<?php if ( have_posts() ) : ?>
				...
				<header class="page-header pad-container" <?php MrGiraffe_schema_microdata( 'element' ); ?>>
					<?php
						...
						// Default for all archives
								...
								the_archive_title( '<h1 class="page-title" ' . MrGiraffe_schema_microdata('entry-title', 0) . '>', '</h1>' );
