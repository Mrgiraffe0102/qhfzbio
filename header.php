			...
			<div class="site-header-bottom">
				...
				<div class="site-header-bottom-fixed">
					...
					<div class="site-header-inside">
						...
						<?php if ( QHFZBIO_check_empty_menu( 'primary' ) && ( has_nav_menu( 'primary' ) || ( true == cryout_get_option('theme_pagesmenu') ) ) ) { ?>
						...
						<?php if ( QHFZBIO_check_empty_menu( 'top' ) && ( has_nav_menu( 'top' ) || ( true == cryout_get_option('theme_pagesmenu') ) ) ) { ?>
						<nav id="access" aria-label="<?php esc_attr_e( 'Top Menu', 'QHFZBIO' ) ?>" <?php cryout_schema_microdata( 'menu' ); ?>>
