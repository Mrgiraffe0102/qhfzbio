...
QHFZBIO WordPress Theme bundles the following third-party libraries and resources:
...
* Added generated 'QHFZBIO-accent-1/2' and 'QHFZBIO-accent-1/2-bg' classnames and 'QHFZBIO-accent-1/2' CSS variables for the main accent colors
...
* Improved single posts fixed next/previous navigation by moving it to hookable QHFZBIO_fixed_nav_links() function and limiting link to same taxonomy
...
* Added missing QHFZBIO.pot file
