...
add_action('woocommerce_before_shop_loop_item_title', 'QHFZBIO_woocommerce_before_buttons', 15);
add_action('woocommerce_before_shop_loop_item_title', 'woocommerce_template_loop_add_to_cart', 16);
add_action('woocommerce_before_shop_loop_item_title', 'QHFZBIO_woocommerce_after_buttons', 17);

function QHFZBIO_woocommerce_before_buttons() {
    echo "<div class='woocommerce-buttons-container'>";
}

function QHFZBIO_woocommerce_after_buttons() {
 ...
 */
add_action('woocommerce_before_shop_loop_item_title', 'QHFZBIO_woocommerce_before_thumbnail', 5);
add_action('woocommerce_before_shop_loop_item_title', 'QHFZBIO_woocommerce_after_thumbnail', 20);

function QHFZBIO_woocommerce_before_thumbnail() {
    echo "<div class='woocommerce-thumbnail-container'>";
}

function QHFZBIO_woocommerce_after_thumbnail() {
