...
function QHFZBIO_body_classes( $classes ) {
	...
	if ( is_front_page() && $options['theme_landingpage'] && ('page' == get_option('show_on_front')) ) {
		$classes[] = 'QHFZBIO-landing-page';
	}

	if ( $options['theme_layoutalign'] ) $classes[] = 'QHFZBIO-boxed-layout';
	...
	if ( $options['theme_menustyle'] ) $classes[] = 'QHFZBIO-fixed-menu';
	if ( $options['theme_menuposition'] && !empty( $header_image ) ) $classes[] = 'QHFZBIO-over-menu';
	if ( $options['theme_menulayout'] == 0 ) $classes[] = 'QHFZBIO-menu-left';
	if ( $options['theme_menulayout'] == 1 ) $classes[] = 'QHFZBIO-menu-right';
	if ( $options['theme_menulayout'] == 2 ) $classes[] = 'QHFZBIO-menu-center';

	if ( $options['theme_topsection'] ) $classes[] = 'QHFZBIO-topsection-reversed';
		else $classes[] = 'QHFZBIO-topsection-normal';

	if ( $options['theme_headerresponsive'] ) $classes[] = 'QHFZBIO-responsive-headerimage';
			else $classes[] = 'QHFZBIO-cropped-headerimage';
	if ( ( $options['theme_headerfullscreen'] == 1 ) || ( ( $options['theme_headerfullscreen'] == 2 ) && is_front_page() ) ) $classes[] = 'QHFZBIO-fullscreen-headerimage';

	if ( $options['theme_fresponsive'] ) $classes[] = 'QHFZBIO-responsive-featured';
		else $classes[] = 'QHFZBIO-cropped-featured';

	if ( $options['theme_magazinelayout'] ) {
		switch ( $options['theme_magazinelayout'] ):
			case 1: $classes[] = 'QHFZBIO-magazine-one QHFZBIO-magazine-layout'; break;
			case 2: $classes[] = 'QHFZBIO-magazine-two QHFZBIO-magazine-layout'; break;
			case 3: $classes[] = 'QHFZBIO-magazine-three QHFZBIO-magazine-layout'; break;
		endswitch;
	}
	switch ( $options['theme_comclosed'] ) {
		case 2: $classes[] = 'QHFZBIO-comhide-in-posts'; break;
		case 3: $classes[] = 'QHFZBIO-comhide-in-pages'; break;
		case 0: $classes[] = 'QHFZBIO-comhide-in-posts'; $classes[] = 'QHFZBIO-comhide-in-pages'; break;
	}
	if ( $options['theme_comlabels'] == 1 ) $classes[] = 'QHFZBIO-comment-placeholder';
	if ( $options['theme_comlabels'] == 2 ) $classes[] = 'QHFZBIO-comment-labels';
	if ( $options['theme_comlabels'] == 3 ) $classes[] = 'QHFZBIO-comment-optlabels';
	if ( $options['theme_comicons'] == 1 ) $classes[] = 'QHFZBIO-comment-icons';
	if ( $options['theme_comdate'] == 1 ) $classes[] = 'QHFZBIO-comment-date-published';
	...
	switch ( $options['theme_contenttitles'] ) {
		case 2: $classes[] = 'QHFZBIO-hide-page-title'; break;
		case 3: $classes[] = 'QHFZBIO-hide-cat-title'; break;
		case 0: $classes[] = 'QHFZBIO-hide-page-title'; $classes[] = 'QHFZBIO-hide-cat-title'; break;
	}

	if ( $options['theme_elementborder'] ) $classes[] = 'QHFZBIO-elementborder';
	if ( $options['theme_elementshadow'] ) $classes[] = 'QHFZBIO-elementshadow';
	if ( $options['theme_elementborderradius'] ) $classes[] = 'QHFZBIO-elementradius';
	if ( $options['theme_normalizetags'] ) $classes[] = 'QHFZBIO-normalizedtags';

	if ( $options['theme_headertitle_anim'] ) $classes[] = 'QHFZBIO-animated-title';

	if ( $options['theme_lazyimages'] == 2 ) $classes[] = 'QHFZBIO-lazy-noanimation';

if ( !empty( $options['theme_articleanimation'] ) ) $classes[] = 'QHFZBIO-article-animation-' . esc_attr( $options['theme_articleanimation'] );

	return $classes;
}
add_filter( 'body_class', 'QHFZBIO_body_classes' );
...
switch ( $theme_layoutalign ) {
	...
	case 0: // wide ?>
			body:not(.QHFZBIO-landing-page) #container, #colophon-inside, .footer-inside, #breadcrumbs-container-inside {
				margin: 0 auto;
				max-width: <?php echo esc_html( $theme_sitewidth ); ?>px;
			}

			body:not(.QHFZBIO-landing-page) #container {
...
?>
:root {
  --QHFZBIO-accent-1: <?php echo esc_html( $theme_accent1 ) ?>;
  --QHFZBIO-accent-2: <?php echo esc_html( $theme_accent2 ) ?>;
}

.QHFZBIO-accent-1 	 { color: <?php echo esc_html( $theme_accent1 ) ?>; }
.QHFZBIO-accent-2 	 { color: <?php echo esc_html( $theme_accent2 ) ?>; }
.QHFZBIO-accent-1-bg { background-color: <?php echo esc_html( $theme_accent1 ) ?>; }
.QHFZBIO-accent-2-bg { background-color: <?php echo esc_html( $theme_accent2 ) ?>; }
...
.QHFZBIO-over-menu .site-header-bottom.header-fixed .site-header-bottom-fixed {
	background-color: <?php echo esc_html( $theme_menubackground ) ?>;
}

.QHFZBIO-over-menu .site-header-bottom-fixed {
	background: transparent;
}

.QHFZBIO-over-menu .header-fixed.site-header-bottom #site-title a,
.QHFZBIO-over-menu .header-fixed.site-header-bottom #site-description {
	color: <?php echo esc_html( $theme_accent1 ) ?>;
}

.QHFZBIO-over-menu #site-title a,
.QHFZBIO-over-menu #site-description,
.QHFZBIO-over-menu #access > div > ul > li,
.QHFZBIO-over-menu #access > div > ul > li > a,
.QHFZBIO-over-menu .site-header-bottom:not(.header-fixed) #nav-toggle,
...
body:not(.QHFZBIO-over-menu) .site-header-bottom #site-title a::before,
.QHFZBIO-over-menu .header-fixed.site-header-bottom #site-title a::before {
	background: <?php echo esc_html( $theme_accent2 ) ?>;
}

body:not(.QHFZBIO-over-menu) .site-header-bottom #site-title a:hover {
	background: <?php echo esc_html( $theme_accent1 ) ?>;
}
...
#access > div > ul > li,
#access > div > ul > li > a,
.QHFZBIO-over-menu .header-fixed.site-header-bottom #access > div > ul > li:not([class*='current']),
.QHFZBIO-over-menu .header-fixed.site-header-bottom #access > div > ul > li:not([class*='current']) > a {
...
.burgermenu-active.QHFZBIO-over-menu .site-header-bottom.header-fixed .site-header-bottom-fixed	{
	background-color: transparent;
}

.burgermenu-active.QHFZBIO-over-menu .site-header-bottom .hamburger span {
	background-color: <?php echo esc_html( $theme_submenutext ) ?>;
}

.QHFZBIO-over-menu:not(.burgermenu-active) .site-header-bottom:not(.header-fixed) .hamburger span {
	background-color: <?php echo esc_html( $theme_menubackground ) ?>;
}
...
.QHFZBIO-over-menu .header-fixed.site-header-bottom #access > div > ul > li > a {
...
article.hentry,
body:not(.blog):not(.page-template-template-blog):not(.archive):not(.search) #container:not(.QHFZBIO-landing-page) .main,
body.QHFZBIO-boxed-layout:not(.QHFZBIO-landing-page) #container {
...
@media (max-width: 720px) {
	.QHFZBIO-magazine-one .main #content-masonry  .post-thumbnail-container + .entry-after-image {
		background-color: <?php echo esc_html( $theme_contentbackground ) ?>;
	}
}
...
.QHFZBIO-normalizedtags #content .tagcloud a {
	color: <?php echo esc_html($theme_contentbackground) ?>;
	background-color: <?php echo esc_html( $theme_accent1 ) ?>;
}

.QHFZBIO-normalizedtags #content .tagcloud a:hover {
	background-color: <?php echo esc_html( $theme_accent2 ) ?>;
}
...
.QHFZBIO-image-five .entry-summary img[class*='align'] 	{
...
.QHFZBIO-striped-table .main thead th,
...
.QHFZBIO-cropped-featured .main .post-thumbnail-container {
	height: <?php echo esc_html( $theme_fheight ) ?>px;
}

.QHFZBIO-responsive-featured .main .post-thumbnail-container {
...
.QHFZBIO-magazine-two.archive #breadcrumbs-nav,
.QHFZBIO-magazine-two.archive .pad-container,
.QHFZBIO-magazine-two.search #breadcrumbs-nav,
.QHFZBIO-magazine-two.search .pad-container {
	padding: <?php echo esc_html( $theme_elementpadding/2 ) ?>%;
}

.QHFZBIO-magazine-three.archive #breadcrumbs-nav,
.QHFZBIO-magazine-three.archive .pad-container,
.QHFZBIO-magazine-three.search #breadcrumbs-nav,
.QHFZBIO-magazine-three.search .pad-container {
	padding: <?php echo esc_html( $theme_elementpadding/3 ) ?>%;
}

<?php } // QHFZBIO_elementpadding
...
.QHFZBIO-responsive-headerimage #masthead #header-image-main-inside {
	max-height: <?php echo esc_html( $theme_headerheight ) ?>px;
}

.QHFZBIO-cropped-headerimage #masthead #header-image-main-inside {
...
@media (min-width: 1152px) {
	<?php if ( esc_html( $theme_menuposition ) ) { ?>
		body:not(.QHFZBIO-landing-page) #site-wrapper {
...
/********** lANDING PAGE **********/
?>
.QHFZBIO-landing-page .lp-blocks-inside,
.QHFZBIO-landing-page .lp-boxes-inside,
.QHFZBIO-landing-page .lp-text-inside,
.QHFZBIO-landing-page .lp-posts-inside,
.QHFZBIO-landing-page .lp-page-inside,
.QHFZBIO-landing-page .lp-section-header,
.QHFZBIO-landing-page .content-widget {
	max-width: <?php echo esc_html( $theme_sitewidth ) ?>px;
}

@media (min-width: 960px) {
	.QHFZBIO-landing-page .lp-blocks.lp-blocks1 .lp-blocks-inside {
...
<?php if ( $theme_lpslider == 3 ) { ?>
	.QHFZBIO-landing-page #header-image-main-inside { display: block; }
<?php } ?>
...
<?php // end </style>
	return apply_filters( 'QHFZBIO_editor_styles', str_replace( '%%scope%%', $scope, ob_get_clean() ) );
} // QHFZBIO_editor_styles()

/* backwards wrapper for QHFZBIO_editor_styles() to output the editor style ajax request */
function QHFZBIO_editor_styles_output() {
	header( 'Content-type: text/css' );
	echo QHFZBIO_editor_styles();
	exit();
} // QHFZBIO_editor_styles_output()
