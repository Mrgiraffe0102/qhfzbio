...
function QHFZBIO_header_image_url() {
	...
	$theme_fheader = apply_filters( 'QHFZBIO_header_image', cryout_get_option( 'theme_fheader' ) );
 ...
 */
add_action ( 'cryout_headerimage_hook', 'QHFZBIO_header_image', 99 );
 ...
 */
add_action ( 'cryout_headerimage_hook', 'QHFZBIO_header_title', 100 );
    ...
    <div id="header-page-title">
        <div id="header-page-title-inside">
			...
			<div class="byline">
				...
				if ( ( ( is_archive() && !function_exists( 'is_shop' ) ) || ( is_archive() && !is_shop() ) ) && cryout_get_option('theme_meta_blog_byline') == 1 ) {
...
add_action ( 'cryout_branding_hook', 'QHFZBIO_title_and_description' );
...
add_action( 'cryout_master_topfooter_hook', 'QHFZBIO_back_top' );
 ...
 * Footer Hook
 */
add_action( 'cryout_master_footerbottom_hook', 'QHFZBIO_master_footer' );
function QHFZBIO_master_footer() {
	...
	echo 'QHFZBIO WordPress Theme by ' . 'Cryout Creations"> ' . 'QHFZBIO' .'</a> &amp; <a target="_blank" href="' . "http://wordpress.org/";
	echo '" title="' . esc_attr__( "Semantic Personal Publishing Platform", "QHFZBIO") . '"> ' . sprintf( " %s", "WordPress" ) . '</a>.</div>';
}

add_action( 'cryout_master_footer_hook', 'QHFZBIO_copyright' );
...
add_action( 'cryout_body_hook', 'QHFZBIO_preloader' );
...
function QHFZBIO_master_hook() {
	...
	if ( $theme_interim_options['theme_breadcrumbs'] )  add_action( 'cryout_breadcrumbs_hook', 'QHFZBIO_breadcrumbs' );
	...
	if ( cryout_get_option( 'theme_socials_header' ) ) 		add_action( 'cryout_header_socials_hook', 'QHFZBIO_socials_menu_header', 10 );
	if ( cryout_get_option( 'theme_socials_footer' ) ) 		add_action( 'cryout_master_footer_hook', 'QHFZBIO_socials_menu_footer', 5 );
	if ( cryout_get_option( 'theme_socials_left_sidebar' ) ) 	add_action( 'cryout_before_primary_widgets_hook', 'QHFZBIO_socials_menu_left', 5 );
	if ( cryout_get_option( 'theme_socials_right_sidebar' ) ) 	add_action( 'cryout_before_secondary_widgets_hook', 'QHFZBIO_socials_menu_right', 5 );
};
endif;
